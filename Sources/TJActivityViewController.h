...
typedef void (^TJActivityViewControllerOverrideBlock)(UIActivityType activityType, void (^completionHandler)(UIActivityType __nullable activityType, BOOL success));
